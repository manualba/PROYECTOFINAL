...
public class AlistarSoldados extends JFrame {
	...
	public AlistarSoldados() {
		...
		JTextArea soldado = new JTextArea();
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if (dni.getText().length() == 8 && (sexo.getText().equals("M") ||sexo.getText().equals("F"))) {
					...
					try {
						...
						c.EjecutarUpdate("INSERT INTO listado_soldados (Nombre, DNI, Sexo, Rango, Cuerpo) VALUES (\""+ soldado.getText() + "\", \""+ dni.getText() + "\", \""+ sexo.getText() + "\",\""+ recluta.getText() + "\",\""+ cuerposoldado.getText() + "\");");
